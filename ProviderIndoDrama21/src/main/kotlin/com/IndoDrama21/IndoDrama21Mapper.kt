...
class IndoDrama21Mapper(
    ...
    fun toSearchResult(element: Element, baseUrl: String? = null): SearchResponse? {
        return runCatching {
            ...
            val cleanRegex = resolveConfig(providerId, IndoDrama21Constants.CONFIG_HREF_CLEAN_REGEXPS, "")
            val cleanReplace = resolveConfig(providerId, IndoDrama21Constants.CONFIG_HREF_CLEAN_REPLACES, "")
