...
class AnichinMapper(
    ...
    fun toSearchResult(element: Element, baseUrl: String? = null): SearchResponse? {
        return runCatching {
            ...
            val cleanRegex = resolveConfig(providerId, AnichinConstants.CONFIG_HREF_CLEAN_REGEXPS, "")
            val cleanReplace = resolveConfig(providerId, AnichinConstants.CONFIG_HREF_CLEAN_REPLACES, "")
