...
import com.Animasu.AnimasuConstants.CONFIG_NAMES
import com.Animasu.AnimasuConstants.CONFIG_MAIN_URLS
import com.Animasu.AnimasuConstants.CONFIG_SERIES_URLS
import com.Animasu.AnimasuConstants.CONFIG_SEARCH_URLS
import com.Animasu.AnimasuConstants.CONFIG_LANGS
import com.Animasu.AnimasuConstants.CONFIG_SUPPORTED_TYPES
import com.Animasu.AnimasuConstants.CONFIG_SEARCH_PATH_PATTERNS
import com.Animasu.AnimasuConstants.CONFIG_MAIN_PAGE_PATH_PATTERNS
import com.Animasu.AnimasuConstants.CONFIG_MOVIE_PATH_SEGMENTS
import com.Animasu.AnimasuConstants.CONFIG_TV_PATH_SEGMENTS
import com.Animasu.AnimasuConstants.CONFIG_EPISODE_DATA_URL_PATTERNS
import com.Animasu.AnimasuConstants.CONFIG_SEARCH_PAGE_LIMITS
import com.Animasu.AnimasuConstants.CONFIG_REVERSE_EPISODES
import com.Animasu.AnimasuConstants.CONFIG_SEARCH_IS_JSON
import com.Animasu.AnimasuConstants.CONFIG_SEARCH_JSON_ROOTS
import com.Animasu.AnimasuConstants.CONFIG_SEARCH_JSON_TITLES
import com.Animasu.AnimasuConstants.CONFIG_SEARCH_JSON_HREFS
import com.Animasu.AnimasuConstants.CONFIG_SEARCH_JSON_POSTERS
import com.Animasu.AnimasuConstants.CONFIG_SEARCH_JSON_POSTER_PREFIXES
import com.Animasu.AnimasuConstants.CONFIG_SEARCH_JSON_TYPES
import com.Animasu.AnimasuConstants.CONFIG_GLOBAL_HEADERS
import com.Animasu.AnimasuConstants.CONFIG_MAIN_PAGE_LISTS
import com.Animasu.AnimasuConstants.FOLLOW_LINK_SELECTOR
import com.Animasu.AnimasuConstants.CONFIG_HREF_CLEAN_REGEXPS
import com.Animasu.AnimasuConstants.CONFIG_HREF_CLEAN_REPLACES
import com.Animasu.AnimasuConstants.SEARCH_ITEMS
import com.Animasu.AnimasuConstants.SEARCH_TITLE
import com.Animasu.AnimasuConstants.SEARCH_HREF
import com.Animasu.AnimasuConstants.SEARCH_POSTER
import com.Animasu.AnimasuConstants.SEARCH_RATING
import com.Animasu.AnimasuConstants.SEARCH_EP_TEXT
import com.Animasu.AnimasuConstants.LOAD_TITLE
import com.Animasu.AnimasuConstants.LOAD_POSTER
import com.Animasu.AnimasuConstants.LOAD_BANNER
import com.Animasu.AnimasuConstants.LOAD_DESC
import com.Animasu.AnimasuConstants.LOAD_INFO_BOX
import com.Animasu.AnimasuConstants.LOAD_TAGS
import com.Animasu.AnimasuConstants.LOAD_RATING
import com.Animasu.AnimasuConstants.LOAD_STATUS
import com.Animasu.AnimasuConstants.LOAD_QUALITY
import com.Animasu.AnimasuConstants.LOAD_TRAILER
import com.Animasu.AnimasuConstants.LOAD_RECOMMEND
import com.Animasu.AnimasuConstants.EPISODE_ITEMS
import com.Animasu.AnimasuConstants.EPISODE_HREF
import com.Animasu.AnimasuConstants.EPISODE_TITLE
import com.Animasu.AnimasuConstants.EPISODE_NUM
import com.Animasu.AnimasuConstants.EPISODE_DESC
import com.Animasu.AnimasuConstants.EPISODE_TIME
import com.Animasu.AnimasuConstants.LINK_OPTIONS
import com.Animasu.AnimasuConstants.DOWNLOAD_ITEMS
import com.Animasu.AnimasuConstants.ACTOR_ITEMS
import com.Animasu.AnimasuConstants.ACTOR_NAME
import com.Animasu.AnimasuConstants.ATTR_TITLE
import com.Animasu.AnimasuConstants.ATTR_IMAGE
import com.Animasu.AnimasuConstants.ATTR_HREF
import com.Animasu.AnimasuConstants.ATTR_VALUE
import com.Animasu.AnimasuConstants.ATTR_CONTENT
import com.Animasu.AnimasuConstants.BLOAT_REGEX
import com.Animasu.AnimasuConstants.DEFAULT_TIMEOUT
import com.Animasu.AnimasuConstants.VAL_REFERER
import com.Animasu.AnimasuConstants.STR_DUB
import com.Animasu.AnimasuConstants.STR_ONGOING
import com.Animasu.AnimasuConstants.STR_EPISODE
import com.Animasu.AnimasuConstants.STR_SERIES
import com.Animasu.AnimasuConstants.CONFIG_HOOK_IS_HORIZONTAL
import com.Animasu.AnimasuConstants.CONFIG_HOOK_YEAR_EXTRACTOR
import com.Animasu.AnimasuConstants.CONFIG_HOOK_YEAR_SELECTOR
import com.Animasu.AnimasuConstants.CONFIG_HOOK_REFERER_PLAYER
import com.Animasu.AnimasuConstants.CONFIG_HOOK_IFRAME_SELECTORS
    ...
    private suspend fun loadRecursive(url: String, depth: Int): LoadResponse {
        ...
        if (isMovie) {
            ...
            return if (type == TvType.Anime || type == TvType.OVA || type == TvType.AnimeMovie) {
                newAnimeSearchResponse(metadata.title, url, type) { this.posterUrl = tracker?.image ?: metadata.poster; this.backgroundPosterUrl = tracker?.cover ?: metadata.banner; this.posterHeaders = globalHeaders.toMutableMap().apply { put(VAL_REFERER, mainUrl) }; this.plot = metadata.description; this.tags = metadata.tags.ifEmpty { null }
