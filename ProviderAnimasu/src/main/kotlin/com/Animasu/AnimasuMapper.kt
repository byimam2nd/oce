...
class AnimasuMapper(
    ...
    fun toSearchResult(element: Element, baseUrl: String? = null): SearchResponse? {
        return runCatching {
            ...
            val cleanRegex = resolveConfig(providerId, AnimasuConstants.CONFIG_HREF_CLEAN_REGEXPS, "")
            val cleanReplace = resolveConfig(providerId, AnimasuConstants.CONFIG_HREF_CLEAN_REPLACES, "")
