...
suspend fun rateLimitDelay() {
    try {
        delay(100L + Random.nextLong(400L))
    } catch (_: Exception) {
    }
}
...
fun String.safeCleanBloat(original: String, regex: Regex): String = try {
...
fun String.safeHttpsify(): String = try {
...
fun String.safeDecode(): String = try {
